...
public class UserInfoModel {
    ...
    public UserInfoModel (String userId, String password, String email, Timestamp lastlogindate, String registerLink,
            Timestamp registerLinkTime, Integer type, String nickName, String userName, String birthday, Integer sex,
            String postcode, String address, String tel, String hireDate, String affiliation, String position,
            String hobby, String specialSkill, String comment, String imageLink) {
    ...
    public String getPostCode () {
        String s = getPostCode1 () + getPostCode2 ();
        setPostCode (s);
        return postcode;
    }
    ...
    public String getTel () {
        String s = getTel1 () + getTel2 () + getTel3 ();
        setTel (s);
        return tel;
    }
